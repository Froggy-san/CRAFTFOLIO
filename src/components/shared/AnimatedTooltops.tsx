            ...
            <AnimatePresence mode="popLayout">
              {hoveredIndex === item.userId && (
                <motion.div
                  ...
                  className="absolute -left-1/2 -top-16 z-50 flex translate-x-1/2 flex-col items-center justify-center rounded-md bg-primary-foreground px-4 py-2 text-xs shadow-xl"
                >
